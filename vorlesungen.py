...
if holidays:
    with st.expander(f"{len(holidays)} Ferienwochen erkannt (hier klicken)"):
    ...
    st.caption("Keine vorlesungsfreie Zeit in der PDF erkannt.")
    use_holidays = False
...
user_query = st.text_input(
    "Gib deine Modulnummern ein (z.B. '1.3, 2.1')", 
    help="Du kannst '1.3' eingeben, um alle Veranstaltungen dieses Moduls zu finden (z.B. 1.3.1, 1.3.2). Du kannst aber auch die Nummern der Vorlesungen einzeln eingeben."
)
